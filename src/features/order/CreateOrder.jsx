...
// React-Router Form handles everything here
// so we didn't need state for each input or submit function
  ...
  return (
    <div className="px-4 py-6">
      ...
      <Form method="POST">
        ...
        <div>
          {/* submitting cart to Form with hidden input */}
...
export async function action({ request }) {
  ...
  // can't use useDispatch outside component
  // import store here so we can clear cart
  store.dispatch(clearCart());
  // using redirect from react-router cuz we cant use useNavigate outside component
